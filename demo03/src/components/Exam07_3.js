                        ...
                        <div className="row">
                            <div className="col col-sm-10 offset-sm-1 col-md-8 offset-md-8 col-lg-6 offset-lg-3">
                                ...
                                <input className={
                                            ...
                                            `} 
                                            type="text" name="memberId" value={member.memberId} onChange={join}/>
                        ...
                        <div className="row">
                            <div className="col col-sm-10 offset-sm-1 col-md-8 offset-md-8 col-lg-6 offset-lg-3">
                                ...
                                <input className={`
                                            ...
                                            `} 
                                            type="password" name="memberPw" value={member.memberPw} onChange={join}/>
                        ...
                        <div className="row">
                            <div className="col col-sm-10 offset-sm-1 col-md-8 offset-md-8 col-lg-6 offset-lg-3">
                                ...
                                <input className={`
                                            ...
                                            `}
                                            type="password" name="memberPwRe" value={member.memberPwRe} onChange={join}/>
